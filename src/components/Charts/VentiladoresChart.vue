  ...
  setup() {
    ...
    const fillChartData = () => {
      chartData.value = getChartData(
        ...
        { data: processedData.value.getVentiladorCima(), label: 'Ventilador Cima' },
        { data: processedData.value.getVentiladorBaixo(), label: 'Ventilador Baixo' }
      );
    };
...
<template>
  <SectionTitleLineWithButton :icon="mdiChartPie" title="Ventiladores Status (%)">
